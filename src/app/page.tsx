    ...
    <div className="min-h-screen bg-warm-gradient">
      ...
      <main>
        ...
        <section className="mx-auto max-w-4xl px-6 py-20 text-center">
          <div className="mb-5 inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
          ...
          <div className="mt-12 rounded-2xl bg-primary/5 border border-primary/10 p-10 text-center">
            ...
            <div className="mx-auto grid max-w-2xl gap-3 text-left">
              {[
                ...
                'Adapts to each child\'s support level (1, 2, and 3)',
